...
// framework and carry their own dark block. Owning the page keeps the whole app
// on one palette, and a stock framework error page in someone's product reads
// as unfinished anyway.
export default function NotFound() {
  return (
    <main className="mx-auto flex w-full max-w-xl flex-1 flex-col justify-center gap-4 px-6 py-20">
